...
BASE_CFLAGS := -Ofast -g0 -DNDEBUG -pipe -Wno-unused-parameter -Wno-unused-value -Wno-unused-function
$(combo_2nd_arch_prefix)TARGET_arm_CFLAGS := -fomit-frame-pointer -funswitch-loops
$(combo_2nd_arch_prefix)TARGET_thumb_CFLAGS := -fomit-frame-pointer
$(combo_2nd_arch_prefix)TARGET_GLOBAL_CFLAGS += $(BASE_CFLAGS)
$(combo_2nd_arch_prefix)TARGET_GLOBAL_CPPFLAGS += $(BASE_CFLAGS) -fvisibility-inlines-hidden
